...
const AskSimpleProject = ({ location }) => {
    ...
    const data = useStaticQuery(graphql`
		query {
            ...
            empathy_map: file(relativePath: { eq: "projects/asksimple/empathy_map.png" }) {
				childImageSharp {
					fluid(maxWidth: 700, maxHeight: 384, quality: 90) {
						...GatsbyImageSharpFluid
					}
				}
            },
            pov: file(relativePath: { eq: "projects/asksimple/pov.png" }) {
				childImageSharp {
					fluid(maxWidth: 600, maxHeight: 388, quality: 90) {
						...GatsbyImageSharpFluid
					}
				}
            },
            ss_answerquestion: file(relativePath: { eq: "projects/asksimple/ss-answerquestion.jpg" }) {
				childImageSharp {
					fluid(maxWidth: 720, maxHeight: 385, quality: 90) {
						...GatsbyImageSharpFluid
					}
				}
            },
            ss_askquestion: file(relativePath: { eq: "projects/asksimple/ss-askquestion.jpg" }) {
				childImageSharp {
					fluid(maxWidth: 1053, maxHeight: 417, quality: 90) {
						...GatsbyImageSharpFluid
					}
				}
            },
            ss_enterclassroom: file(relativePath: { eq: "projects/asksimple/ss-enterclassroom.jpg" }) {
				childImageSharp {
					fluid(maxWidth: 704, maxHeight: 340, quality: 90) {
						...GatsbyImageSharpFluid
					}
				}
            },
            ss_navigation: file(relativePath: { eq: "projects/asksimple/ss-navigation.jpg" }) {
				childImageSharp {
					fluid(maxWidth: 713, maxHeight: 372, quality: 90) {
						...GatsbyImageSharpFluid
					}
				}
            },
            ss_upvote: file(relativePath: { eq: "projects/asksimple/ss-upvote.jpg" }) {
				childImageSharp {
					fluid(maxWidth: 536, maxHeight: 419, quality: 90) {
						...GatsbyImageSharpFluid
					}
				}
            },
        ...
        <>
            ...
            <div className="work">
                ...
                <section className="body">
                    ...
                    <p>"What do you find frustrating in the classroom?"</p>
                    ...
                    <Image
                            className="image"
                            fluid={data.pov.childImageSharp.fluid}
                            alt="Initial Point-of-View" />
                    <div className="caption">Initial Point-of-View</div>
                    ...
                    <Image
                        className="image"
                        fluid={data.empathy_map.childImageSharp.fluid}
                        alt="Empathy Map" />
                    <div className="caption">Empathy Map</div>
                    ...
                    <Image
                        className="image"
                        fluid={data.ss_enterclassroom.childImageSharp.fluid}
                        alt="Lo-fi Prototype - Enter classroom" />

                    <p><b>Navigation:</b><br />Users can navigate in the order: Choose a course -> choose a session -> choose a question.</p>

                    <Image
                        className="image"
                        fluid={data.ss_navigation.childImageSharp.fluid}
                        alt="Lo-fi Prototype - Navigation" />
                    ...
                    <Image
                        className="image"
                        fluid={data.ss_askquestion.childImageSharp.fluid}
                        alt="Lo-fi Prototype - Ask Question" />
                    ...
                    <Image
                        className="image"
                        fluid={data.ss_answerquestion.childImageSharp.fluid}
                        alt="Lo-fi Prototype - Answer Question" />
                    ...
                    <Image
                        className="image"
                        fluid={data.ss_upvote.childImageSharp.fluid}
                        alt="Lo-fi Prototype - Upvote" />
                    ...
                    <div className="embed-responsive embed-responsive-16by9">
                        <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/yZC8SCDMloU" allowFullScreen></iframe>
                    </div>
                    ...
                    <div className="embed-responsive embed-responsive-16by9">
                        <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/pP_nR8pnHXU" allowFullScreen></iframe>
                    </div>
                </section>
