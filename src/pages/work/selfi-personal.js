...
const SelfiProject = ({ location }) => {
    ...
    const data = useStaticQuery(graphql`
		query {
			bg: file(relativePath: { eq: "projects/selfi-personal/bg.png" }) {
				childImageSharp {
            ...
            selfi_colours: file(relativePath: { eq: "projects/selfi-personal/selfi-colours.png" }) {
				childImageSharp {
            ...
            selfi_logos: file(relativePath: { eq: "projects/selfi-personal/selfi-logos.png" }) {
				childImageSharp {
                    ...
                    <div className="row">
                        <div className="col-12 col-md-6 order-2 order-md-1">
                            <div className="project-details">
                                <h1 className="wipeIn ani-1">Selfi Personal</h1>
                                <div className="description">
                                    <ul>
                                        <li>
                                            <p className="name wipeIn ani-2">Period</p>
                                            <p className="desc wipeIn ani-2">January to July 2020</p>
                                        </li>
                                        <li>
                                ...
                                <a className="btn-primary btn-hover-pulse" role="button" href="https://selfipersonal.ai" target="_blank" rel="noopener noreferrer">Visit website</a>
                            </div>
                        </div>
