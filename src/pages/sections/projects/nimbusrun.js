    ...
    return (
        <>
            ...
            <section className="popupBody">
                ...
                <p>As part of our software construction <a href="https://istd.sutd.edu.sg/undergraduate/courses/50003-elements-of-software-construction" target="_blank" rel="noopener">course</a>, our team of four, made up of people from different cultures, came up with an Android game that utilizes network and concurrency skills we picked up during the course.
            </p>
                ...
                <p>This final product is none other than <a href="https://play.google.com/store/apps/details?id=com.lemoninc.nimbusrun" alt="Nimbus Run on Play Store" target="_blank" rel="noopener">Nimbus Run</a>. It’s a Fun Run-inspired racing game with our Asian mythological and legendary twist to it. Everything in this game is epic – epic backgrounds, epic gameplay, epic sounds and of course epic characters that are based on cloud. Hence the game name, Nimbus Run.</p>
